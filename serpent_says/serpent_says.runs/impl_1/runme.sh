...
HD_PWD='C:/Users/aront/ES3B2/serpent_says/serpent_says.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_serpent_says.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_serpent_says.tcl -notrace
