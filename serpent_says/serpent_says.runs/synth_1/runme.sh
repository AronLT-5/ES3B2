...
HD_PWD='C:/Users/aront/ES3B2/serpent_says/serpent_says.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_serpent_says.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_serpent_says.tcl
