// ============================================================================
// ML Top (CNN variant) — Full Audio-to-Classification Pipeline
// ============================================================================
// Drop-in replacement for ml_top_bnn in the Serpent Says game.
// Same port interface — just swap the module name.
//
//   PDM mic -> CIC -> frame buffer -> feature pipeline -> context buffer
//   -> normalizer (256 int8 features) -> CNN inference -> command filter
//   -> voice_turn_req
//
// CNN: Conv1(3x3,1->16) -> Pool1 -> Conv2(3x3,16->32) -> Pool2
//      -> Dense(512->32,ReLU) -> Dense(32->3,argmax)
//
// Float accuracy: 92.0%, Quantized: 89.3%
// ============================================================================
...
module ml_top_cnn #(
    ...
    parameter signed [7:0] CONF_THRESH   = 8'sd2,
    parameter signed [7:0] MARGIN_THRESH = 8'sd3,
    ...
    cnn_inference u_cnn (
        ...
        .kws_class (inf_class),
        .kws_conf  (inf_conf),
        .kws_second(inf_second),
        .kws_valid (inf_valid)
    );

    // ════════════════════════════════════════════════════════════
    // 8. Command Filter (confidence + margin + cooldown)
    // ════════════════════════════════════════════════════════════
    command_filter #(
    ...
    // ════════════════════════════════════════════════════════════
    // 9. Sequencing: context_ready -> normalize -> infer
    // ════════════════════════════════════════════════════════════
