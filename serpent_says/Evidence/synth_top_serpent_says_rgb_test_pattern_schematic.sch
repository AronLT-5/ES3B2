...
load symbol vga_controller work:vga_controller:NOFILE HIERBOX pin CPU_RESETN output.right pin CPU_RESETN_IBUF input.left pin VGA_HS_OBUF output.right pin VGA_VS_OBUF output.right pin clk_pix_BUFG input.left pinBus VGA_B_OBUF output.right [0:0] pinBus VGA_G_OBUF output.right [0:0] pinBus VGA_R_OBUF output.right [0:0] boxcolor 1 fillcolor 2 minwidth 13%
load port CLK100MHZ input -pg 1 -lvl 0 -x 0 -y 420
load port CPU_RESETN input -pg 1 -lvl 0 -x 0 -y 530
load port VGA_HS output -pg 1 -lvl 7 -x 1600 -y 600
load port VGA_VS output -pg 1 -lvl 7 -x 1600 -y 670
load portBus VGA_B output [3:0] -attr @name VGA_B[3:0] -pg 1 -lvl 7 -x 1600 -y 40
load portBus VGA_G output [3:0] -attr @name VGA_G[3:0] -pg 1 -lvl 7 -x 1600 -y 320
load portBus VGA_R output [3:0] -attr @name VGA_R[3:0] -pg 1 -lvl 7 -x 1600 -y 740
...
load inst VGA_B_OBUF[0]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 40
load inst VGA_B_OBUF[1]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 110
load inst VGA_B_OBUF[2]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 180
load inst VGA_B_OBUF[3]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 250
load inst VGA_G_OBUF[0]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 320
load inst VGA_G_OBUF[1]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 390
load inst VGA_G_OBUF[2]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 460
load inst VGA_G_OBUF[3]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 530
load inst VGA_HS_OBUF_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 600
load inst VGA_R_OBUF[0]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 740
load inst VGA_R_OBUF[1]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 810
load inst VGA_R_OBUF[2]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 880
load inst VGA_R_OBUF[3]_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 950
load inst VGA_VS_OBUF_inst OBUF hdi_primitives -attr @cell(#000000) OBUF -pg 1 -lvl 6 -x 1400 -y 670
...
load inst u_vga_controller vga_controller work:vga_controller:NOFILE -autohide -attr @cell(#000000) vga_controller -pinBusAttr VGA_B_OBUF @name VGA_B_OBUF -pinBusAttr VGA_G_OBUF @name VGA_G_OBUF -pinBusAttr VGA_R_OBUF @name VGA_R_OBUF -pg 1 -lvl 5 -x 1130 -y 530
...
load net VGA_B_OBUF[0] -attr @rip VGA_B_OBUF[0] -pin VGA_B_OBUF[0]_inst I -pin VGA_B_OBUF[1]_inst I -pin VGA_B_OBUF[2]_inst I -pin VGA_B_OBUF[3]_inst I -pin u_vga_controller VGA_B_OBUF[0]
netloc VGA_B_OBUF[0] 1 5 1 1340 40n
...
load net VGA_G_OBUF[0] -attr @rip VGA_G_OBUF[0] -pin VGA_G_OBUF[0]_inst I -pin VGA_G_OBUF[1]_inst I -pin VGA_G_OBUF[2]_inst I -pin VGA_G_OBUF[3]_inst I -pin u_vga_controller VGA_G_OBUF[0]
netloc VGA_G_OBUF[0] 1 5 1 1360 320n
...
load net VGA_R_OBUF[0] -attr @rip VGA_R_OBUF[0] -pin VGA_R_OBUF[0]_inst I -pin VGA_R_OBUF[1]_inst I -pin VGA_R_OBUF[2]_inst I -pin VGA_R_OBUF[3]_inst I -pin u_vga_controller VGA_R_OBUF[0]
netloc VGA_R_OBUF[0] 1 5 1 1360 620n
...
netloc VGA_VS_OBUF 1 5 1 1320J 640n
...
netloc u_vga_controller_n_1 1 2 4 490 480 NJ 480 NJ 480 1320
load netBundle @VGA_B 4 VGA_B[3] VGA_B[2] VGA_B[1] VGA_B[0] -autobundled
netbloc @VGA_B 1 6 1 1580 40n
load netBundle @VGA_G 4 VGA_G[3] VGA_G[2] VGA_G[1] VGA_G[0] -autobundled
netbloc @VGA_G 1 6 1 1580 320n
load netBundle @VGA_R 4 VGA_R[3] VGA_R[2] VGA_R[1] VGA_R[0] -autobundled
netbloc @VGA_R 1 6 1 1580 740n
levelinfo -pg 1 0 40 250 620 770 1130 1400 1600
pagesize -pg 1 -db -bbox -sgen -150 0 1730 990
show
fullfit
#
